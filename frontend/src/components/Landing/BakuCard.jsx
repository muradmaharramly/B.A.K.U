...
import { FaBus, FaSync } from 'react-icons/fa';
    ...
    <section className={styles.section} id="baku-card">
      <div className={styles.container}>
        <div className={styles.header}>
          <span className={styles.badge}><FaBus /> B.A.K.U Card</span>
          <h2 className={styles.title}>
            Your Digital <span className={styles.highlight}>Transit Card</span>
          </h2>
          <p className={styles.subtitle}>
            One card for everything. Interactive 3D design with real-time sync.
          </p>
        </div>

        <div className={styles.cardScene}>
          <motion.div
            className={`${styles.cardBody} ${flipped ? styles.flipped : ''}`}
            onClick={() => {
              setFlipped(!flipped);
              setRotate({ x: 0, y: 0 });
            }}
          ...
          >
            ...
            <div className={styles.front}>
              ...
              <div className={styles.cardLogoTop}>B.A.K.U</div>
              <div className={styles.chip}>
                <div className={styles.chipLine}></div>
                <div className={styles.chipLine}></div>
              </div>
              <div className={styles.number}>4276 •••• •••• 8421</div>
              <div className={styles.row}>
                <div>
                  <div className={styles.label}>Card Holder</div>
                  <div className={styles.value}>Əli Məmmədov</div>
                </div>
                <div>
                  <div className={styles.label}>Balance</div>
                  <div className={styles.balance}>₼12.50</div>
                </div>
              </div>
              <div className={styles.tier}>CITIZEN — Standard</div>
              <div className={styles.flipHint}><FaSync /> Tap to flip</div>
            </div>
            ...
            <div className={styles.back}>
              ...
              <div className={styles.flipHint}><FaSync /> Tap to flip back</div>
            </div>
          </motion.div>
        </div>
      </div>
